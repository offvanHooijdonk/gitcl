...
@Subcomponent(modules = {AccountModule.class, AuthModule.class})
@UtilsScope
public interface AuthenticateComponent {

    LoginScreenComponent plusLoginScreenComponent(LoginScreenModule loginScreenModule, AuthenticatorModule authenticatorModule);
}
